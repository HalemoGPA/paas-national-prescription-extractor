...
class ComprehensiveTestSuite:
    ...
    def generate_edge_cases(self) -> List[PrescriptionInput]:
        ...
        edge_cases = [
            # Misspellings
            PrescriptionInput("Fluonase", "1", "2 sprays each nostril bid"),  # Flonase misspelled
            PrescriptionInput("Albuteral", "1", "2 puffs q4h prn"),  # Albuterol misspelled
            ...
            PrescriptionInput("fluticasone nasal spray", "2", "2 sprays each nostril daily"),
            
            # Unusual quantities
            PrescriptionInput("Humira", "12", "inject every other week"),  # High quantity
            PrescriptionInput("Ventolin HFA", "0.5", "2 puffs prn"),  # Fractional quantity
            PrescriptionInput("Eye drops", "100", "1 drop ou bid"),  # Very high quantity
            
            # Complex sigs
            PrescriptionInput("Humalog", "5", "sliding scale: 8-12 units ac tid based on blood sugar"),
            PrescriptionInput("Albuterol HFA", "2", "2-4 puffs q4-6h prn sob/wheeze, max 12 puffs/day"),
            ...
            # Mixed units
            PrescriptionInput("Testosterone cypionate", "10ml", "inject 1ml every 2 weeks"),
            PrescriptionInput("B12", "1000mcg", "inject monthly"),
        ]
        
        return edge_cases
    
    def run_test_batch(self, test_cases: List[PrescriptionInput], category: str) -> Dict:
