...
def format_result(result):
    ...
    print(f"Medication Type:    {result.medication_type.value.replace('_', ' ').title()}")
    ...
    while True:
        ...
        if choice in ['5', 'quit', 'exit', 'q']:
            ...
            test_cases = [
                ...
                PrescriptionInput("Ventolin HFA", "1", "2 puffs every 4 hours as needed"),
            ...
            print("─"*80)
            print(f"{'#':<3} {'Drug Name':<25} {'Type':<15} {'Qty':<8} {'Days':<6} {'Confidence':<10}")
            print("─"*80)
            ...
            for i, result in enumerate(results, 1):
                ...
                print(f"{i:<3} {drug_name:<25} {med_type:<15} {qty:<8} {days:<6} {conf:<10}")
